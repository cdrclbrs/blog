...
[GitHub source](https://github.com/cdrclbrs/EDFTempoVision){:target="_blank"}
...
Objective was to be able to alert multiple persons at same time, through text messaging
...
Here is the Bot code for sending messages to the Chat ID - see bot father to create the bot and get a token
...
Now me and my family can get the Telegram Notification updates that reflect the next day for the Tempo EDF Contract Days given by RTE.
